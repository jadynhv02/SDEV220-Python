...
## 3.6 Question: The floating point value and integer value are different because of how it
##               is stored. It takes 64-bits to store a float and 32-bits to store an integer.